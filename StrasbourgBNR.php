<?php $titre= "Contact Strasbourg BNR";?>
...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>CIRISI STRASBOURG</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_RELATIONS_CLIENTS&Cirisi=Strasbourg"   role="button">CONTACT CIRISI STRASBOURG RELATIONS CLIENTS</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_CHARGE_DE_COMMUNICATION&Cirisi=Strasbourg"  role="button">CONTACT CIRISI STRASBOURG CHARGE DE COMMUNICATION</a><br>
    </div>
