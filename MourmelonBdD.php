<?php $titre= "Contact Mourmelon BdD";?>
...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>Base de Défense de Mourmelon</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contactBdD?Enseigne=COORDINATEURS_SIC&BdD=Mourmelon"   role="button">CONTACT COORDINATEUR SIC MOURMELON</a><br>
    </div>
