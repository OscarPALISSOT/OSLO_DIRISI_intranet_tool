<div class="modal fade" id="<?php echo "edit".$query["BdD"] .$query["Enseigne"]?>"  tabindex="-1" aria-labelledby="ModalModifQuartiersLabel"  aria-hidden="true">
...
<div class="container">
                            ...
                            <input id="fID" name="fID" type="hidden" value="<?php echo $donnees1['ID']?>">
                            ...
                            <input id="fPrénom" name="fPrénom" class="col " value="<?php echo $donnees1['Prénom']?>">
                            </div>

                            <div class="row">
                            <label for="fEmail" class="col-auto"><span>Email:</span></label>
                            <input id="fEmail" name="fEmail" class="col " value="<?php echo $donnees1['Email']?>">
                            </div>

                            <div class="row">
                            <label for="fTPH" class="col-auto"><span>Email:</span></label>
                            <input id="fTPH" name="fTPH" class="col " value="<?php echo $donnees1['TPH']?>">
                            </div>
