...
Encore
    ...
    .addEntry('contactJS', './assets/js/Bases/contactJS.js')
    .addEntry('cardEntity', './assets/js/Bases/cardEntity.js')

    .addStyleEntry('bootstrap', './assets/bootstrap-5.1.3-dist/css/bootstrap.css')
    .addStyleEntry('style', './assets/styles/style.scss')
    .addStyleEntry('home', './assets/styles/Bases/home.scss')
    .addStyleEntry('login', './assets/styles/Bases/login.scss')
    .addStyleEntry('sidenav', './assets/styles/sidenav.scss')
    .addStyleEntry('cards', './assets/styles/cards.scss')
    .addStyleEntry('contact', './assets/styles/Bases/contact.scss')
    ...
    .addStyleEntry('gestionEntity', './assets/styles/Bases/gestionEntity.scss')
