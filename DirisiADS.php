...
<div class="container"> 
    ...
    <div class="container">
             <h1>CONTACT DIRISI</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contactADS?Enseigne=CHARGE_DE_COMPTE&ADS=DIRISI"   role="button"><strong>CHARGE DE COMPTE DIRISI</strong></a><br>
    </div>
