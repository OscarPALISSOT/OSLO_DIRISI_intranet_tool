<?php $titre= "Contact Saint-Dizier BNR";?>
...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>CIRISI SAINT-DIZIER</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_RELATIONS_CLIENTS&Cirisi=Saint-Dizier"   role="button">CONTACT CIRISI SAINT-DIZIER RELATIONS CLIENTS</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_CHARGE_DE_COMMUNICATION&Cirisi=Saint-Dizier"  role="button">CONTACT CIRISI SAINT-DIZIER CHARGE DE COMMUNICATION</a><br>
    </div>
