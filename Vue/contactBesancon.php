...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             ...
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=MIM3&Cirisi=Besançon"   role="button">CONTACT CIRISI BESANCON MIM3</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=OPERA&Cirisi=Besançon"  role="button">CONTACT CIRISI BESANCON OPERA</a><br>
    </div>
