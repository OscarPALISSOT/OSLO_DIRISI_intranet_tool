<div class="modal fade" id="<?php echo "edit_modip".$_GET["ID"]?>"  tabindex="-1" aria-labelledby="ModalModifModipLabel"  aria-hidden="true">
<div class="modal-dialog modal-lg modal-dialog-centered">
<div class="modal-content">

<div class="modal-header">
<h5 id="ModalModifModipLabel" class="text-center model-title text-info"> Modification MODIP </h5>
<button type="button" class="close btn-close bg-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
<div class="container">
                            <form  method="post" action="Vue/scripts/script_modifierModip.php" autocomplete="off" id="modip_edit<?php echo $_GET["ID"]; ?>">
