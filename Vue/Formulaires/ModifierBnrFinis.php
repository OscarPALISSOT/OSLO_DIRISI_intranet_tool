<div class="modal fade" id="<?php echo "edit-bnrfinis".$_GET["ID"]?>" tabindex="-1" aria-labelledby="ModalModifBnrLabel"  aria-hidden="true">
<div class="modal-dialog modal-lg modal-dialog-centered">
<div class="modal-content">

<div class="modal-header">
<h5 id="ModalModifBnrLabel" class="text-center model-title text-info"> Modification BNR FINIS </h5>
