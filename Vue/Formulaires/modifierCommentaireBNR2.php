...
<h5 id="ModalModifBnrLabel" class="text-center model-title text-info"> Modification Commentaire BNR FINIS </h5>
<button type="button" class="close btn-close bg-white" data-bs-dismiss="modal" aria-label="Close"></button>

            </div>
<div class="container modal-body">
                            <form  method="post" action="Vue/scripts/script_commentaireBNR2.php" autocomplete="off" id="edit<?php echo $val["ID"] ?>">
