...
<div class="container"> 
    ...
    <div class="container">
             <h1>CONTACT SCA</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contactADS?Enseigne=CHARGE_DE_COMPTE&ADS=SCA/CICoS/DDGN"   role="button"><strong>CHARGE DE COMPTE SCA</strong></a><br>
    </div>
