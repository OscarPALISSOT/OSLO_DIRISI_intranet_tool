<?php $titre= "Contact Strasbourg BdD";?>
...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>Base de Défense de Strasbourg</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contactBdD?Enseigne=COORDINATEURS_SIC&BdD=Strasbourg"   role="button">CONTACT COORDINATEUR SIC STRASBOURG</a><br>
    </div>
