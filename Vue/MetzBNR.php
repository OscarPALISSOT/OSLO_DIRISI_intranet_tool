...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>CIRISI METZ</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_RELATIONS_CLIENTS&Cirisi=Montigny"   role="button">CONTACT CIRISI METZ RELATIONS CLIENTS</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_CHARGE_DE_COMMUNICATION&Cirisi=Montigny"  role="button">CONTACT CIRISI METZ CHARGE DE COMMUNICATION</a><br>
    </div>
