<?php $titre= "Contact Saint-Dizier";?>
...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             ...
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=MIM3&Cirisi=Saint-Dizier"   role="button">CONTACT CIRISI SAINT-DIZIER MIM3</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=OPERA&Cirisi=Saint-Dizier"  role="button">CONTACT CIRISI SAINT-DIZIER OPERA</a><br>
    </div>
