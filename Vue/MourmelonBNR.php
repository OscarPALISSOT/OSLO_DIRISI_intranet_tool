<?php $titre= "Contact Mourmelon BNR";?>
...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>CIRISI CHAMPAGNE</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_RELATIONS_CLIENTS&Cirisi=Champagne"   role="button">CONTACT CIRISI CHAMPAGNE RELATIONS CLIENTS</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=BRC_CHARGE_DE_COMMUNICATION&Cirisi=Champagne"  role="button">CONTACT CIRISI CHAMPAGNE CHARGE DE COMMUNICATION</a><br>
    </div>
