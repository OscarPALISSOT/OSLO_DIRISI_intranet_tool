...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>CIRISI MONTIGNY</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=MIM3&Cirisi=Montigny-les-Metz"   role="button">CONTACT CIRISI MONTIGNY MIM3</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=OPERA&Cirisi=Montigny"  role="button">CONTACT CIRISI MONTIGNY OPERA</a><br>
    </div>
  </div>
