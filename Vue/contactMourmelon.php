...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             <h1>CIRISI MOURMELON</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=MIM3&Cirisi=Champagne(Sissonne)&Cirisi=Champagne(Chalons-Mourmelon-Suippes)"   role="button">CONTACT CIRISI MOURMELON MIM3</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=OPERA&Cirisi=Champagne"  role="button">CONTACT CIRISI MOURMELON OPERA</a><br>
    </div>
  </div>
