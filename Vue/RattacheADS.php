...
<div class="container"> 
    ...
    <div class="container">
             <h1>CONTACT RATTACHE ADS</h1><br>
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contactADS?Enseigne=CHARGE_DE_COMPTE&ADS=Rattaché ADS"   role="button"><strong>CHARGE DE COMPTE RATTACHE ADS</strong></a><br>
    </div>
