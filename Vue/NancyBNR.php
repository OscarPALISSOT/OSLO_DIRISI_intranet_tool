...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             ...
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=Relations_Clients&Cirisi=Nancy"   role="button">CONTACT CIRISI NANCY RELATIONS CLIENTS</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=Charge_de_Communication&Cirisi=Nancy"  role="button">CONTACT CIRISI NANCY CHARGE DE COMMUNICATION</a><br>
    </div>
