...
<div id="filAriane" class="vingt" itemscope="" itemtype="">
    ...
    <div class="container">
             ...
             <div class="btn-group-vertical" role="group" aria-label="Groupe de boutons en colonne">
                <a class="btn btn-primary" href="/contact?Enseigne=MIM3&Cirisi=Lille"   role="button">CONTACT CIRISI LILLE MIM3</a><br>
                <a class="btn btn-primary" href="/contact?Enseigne=OPERA&Cirisi=Lille"  role="button">CONTACT CIRISI LILLE OPERA</a><br>
    </div>
